...
CREATE INDEX IX_VUEL_AVIO ON VUELO (AVIO_ID);
...
CREATE INDEX IX_ASIE_RESE ON ASIENTO (RESE_ID);
...
CREATE INDEX IX_FACT_USUA ON FACTURA (USUA_ID);
...
-- RELATIONSHIPS
ALTER TABLE VUELO
    ADD CONSTRAINT VUEL_AVIO_FK FOREIGN KEY ( AVIO_ID )
...
ALTER TABLE ASIENTO
    ADD CONSTRAINT ASIE_RESE_FK FOREIGN KEY ( RESE_ID )
...
ALTER TABLE FACTURA
    ADD CONSTRAINT FACT_USUA_FK FOREIGN KEY ( USUA_ID )
